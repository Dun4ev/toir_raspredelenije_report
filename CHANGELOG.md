...
- Унифицирована нормализация кодов объектов: ведущие нули удаляются для любого числового суффикса (`GMS01` → `GMS1`).
- README дополнен актуальной инструкцией по сборке исполняемого файла.
